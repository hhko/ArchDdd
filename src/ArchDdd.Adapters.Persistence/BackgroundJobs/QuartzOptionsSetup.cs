...
internal class QuartzOptionsSetup : IConfigureOptions<QuartzOptions>
{
    public void Configure(QuartzOptions options)
    {
        ...
        //options
        //    .AddJob<DeleteOutdatedSoftDeletableEntitiesJob>(jobBuilder => 
        //        jobBuilder
        //            .WithIdentity(deleteOutdatedSoftDeletableEntitiesJobKey))
        //    .AddTrigger(trigger =>
        //        trigger
