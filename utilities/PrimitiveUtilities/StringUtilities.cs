...
public static class StringUtilities
{
    ...
    public static bool ContainsIllegalCharacter(this string input, SearchValues<char> illeagalCharacterSearchValues)
    {
        return input.AsSpan().IndexOfAny(illeagalCharacterSearchValues) is not -1;
    }
